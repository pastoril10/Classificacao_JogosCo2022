...
st.title("Previsões dos jogos da copa")
st.text("Algoritmo de Machine Learning capaz de prever que vai ganhar um jogo na copa 2022")

df_selecoes = pd.read_csv("data/Selecoes2022.csv")
...
df_campeoes = pd.read_csv("data/campeoes_edited.csv")
